...
def main_loop(config):
    ...
    logger_intro = pl_loggers.TensorBoardLogger(config.log_dir, name='introspector', version=config.version)
    logger_reason = pl_loggers.TensorBoardLogger(config.log_dir, name='reasoner', version=config.version)
